...
public class Pet_Trainers_Near_Me extends AppCompatActivity {
    ...
    class description_webscrape extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String url = "https://www.google.com/search?tbs=lf:1,lf_ui:2&tbm=lcl&q=pet+trainers+near+"+location+"&rflfq=1&num=10&sa=X&ved=2ahUKEwitjvSZ7uv2AhWoy4sBHQ53D3QQjGp6BAgtEAE&biw=1920&bih=969#rlfi=hd:;si:;mv:[[22.720193899999998,88.4462104],[22.3435536,88.30643549999999]];tbs:lrf:!1m4!1u3!2m2!3m1!1e1!1m4!1u2!2m2!2m1!1e1!2m1!1e2!2m1!1e3!3sIAE,lf:1,lf_ui:2";
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Location_Adapter Yash = new Location_Adapter(Pet_Trainers_Near_Me.this, R.layout.location_layout, names, address, mobno, website, star);
                            recyclerView2.setLayoutManager(new LinearLayoutManager(Pet_Trainers_Near_Me.this));
