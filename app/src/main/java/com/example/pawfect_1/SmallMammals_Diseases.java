...
public class SmallMammals_Diseases extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://github.com/Yash-Mawalkar/Database_For_App/blob/main/Small_Mammals_Diseases1.xls?raw=true";
        ...
        try {
            client.get(url, new FileAsyncHttpResponseHandler(this) {
                ...
                public void onFailure(int statusCode, Header[] headers, Throwable throwable, File file) {
                    ...
                    Toast.makeText(SmallMammals_Diseases.this, "Download Failed !!", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onSuccess(int statusCode, Header[] headers, File file) {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(SmallMammals_Diseases.this, "File Downloaded !!!", Toast.LENGTH_SHORT).show();
